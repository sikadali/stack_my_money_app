...
import 'package:stack_my_money_app/src/common_widgets/carousel_widget.dart';
...
import 'package:stack_my_money_app/src/common_widgets/month_carousel.dart';
        ...
        children: [
          ...
          Container(
              ...
              child: Row(
                ...
                children: [
                  Column(children: [
                    Text("Revenus", style: Theme.of(context).textTheme.displayMedium),
          ...
          Padding(
              ...
              child: Row(
                children: [
                  Text("Dernières transactions", style: Theme.of(context).textTheme.headlineSmall),
                ],
              )),
          const SizedBox(height: 10),
          Expanded(
