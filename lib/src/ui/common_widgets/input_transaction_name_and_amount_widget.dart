...
import 'package:stack_my_money_app/src/ui/common_widgets/dropdown_menu.dart';
import 'package:stack_my_money_app/src/ui/common_widgets/numeric_keypad.dart';
...
import 'package:stack_my_money_app/src/ui/utils/theme/ui_data_utils.dart';

class InputTransactionNameAndAmountWidget extends StatefulWidget {
  const InputTransactionNameAndAmountWidget({super.key});

  @override
  State<InputTransactionNameAndAmountWidget> createState() =>
      _InputTransactionNameAndAmountWidgetState();
}

class _InputTransactionNameAndAmountWidgetState
    extends State<InputTransactionNameAndAmountWidget> {
  ...
  void _validateAndSubmit() {
    setState(() {
      ...
      if (_transactionAmountController.text.isNotEmpty &&
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text(sWantToConfirmTransactionCreationText,
          ...
          actions: <Widget>[
            ...
            TextButton(
              ...
              onPressed: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                      content: Text(sTransactionSuccessfullyCreatedText)),
                );
              },
            ),
          ],
          ...
          Row(
            ...
            children: [
              SDropDownMenu(
                  ...
                  items: UIDataUtils.getDropdownItemsForCurrencies()),
              SizedBox(
