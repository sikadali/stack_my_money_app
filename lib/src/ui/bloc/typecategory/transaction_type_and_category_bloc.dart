...
class TransactionTypeAndCategoryBloc extends Bloc<
    TransactionTypeAndCategoryEvent, TransactionTypeAndCategoryState> {
  TransactionTypeAndCategoryBloc()
      : super(TransactionTypeIsExpenses(
            _getDropdownItemsForTransactionCategoryForExpenses())) {
    on<ChangeTransactionTypeToIncomes>((event, emit) {
      emit(TransactionTypeIsIncomes(
          _getDropdownItemsForTransactionCategoryForIncomes()));
    });
  ...
  static List<Couple<IconData, String>>
      _getDropdownItemsForTransactionCategoryForExpenses() {
